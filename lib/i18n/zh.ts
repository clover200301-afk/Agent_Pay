...
export const zh: Dict = {
  ...
  payment: {
    ...
    price: "价格",
    method: "支付方式",
    monFallbackHint: "USDC 余额不足，改用原生 MON 支付。",
    network: "网络",
    gasFee: "Gas 费",
    settlesIn: "结算时间",
    confirming: "确认中…",
  ...
  tx: {
    ...
    apiKeyHint: "请妥善保管 —— provider 接受此 key 作为 Bearer Token。",
    ...
    issueFailedTitle: "已付款，但 key 颁发失败",
    issueFailedDesc:
      "USDC 已在链上付款成功，但服务端未能验证事件。可以安全重试。",
    issueFailedRetry: "重试颁发 key",
    issueFailedSupport: "在浏览器查看交易",
  },
  ...
  setup: {
    eyebrow: "环境检查",
    title: "{n}/{total} 项就绪 —— 完成余下步骤即可运行真实 demo",
    llmLabel: "LLM API 密钥",
    llmTodo: "至少配置一个模型，才能驱动 Agent。",
    llmDone: "已配置模型密钥。",
    walletLabel: "钱包",
    walletTodo: "连接钱包以签 Monad 交易。",
    walletDone: "钱包已连接。",
    chainLabel: "Monad 测试网",
    chainTodo: "切换到 Monad 测试网（chain id 10143）。",
    chainDone: "已在 Monad 测试网。",
    balanceLabel: "测试资金",
    balanceNoMon: "需要少量 MON 作为 gas。",
    balanceNoUsdc: "需要测试 USDC 才能完成支付（≥ 3.8 USDC）。",
    balanceNoFunds: "需要 ≥ 3.8 USDC，或 ≥ 0.039 MON（自动 fallback 到 MON 支付）。",
    balancePendingChain: "请先连接钱包并切换到正确网络。",
    balanceDone: "钱包已充值，可运行 demo。",
    balanceDoneMon: "已充值 —— 将用原生 MON 支付（USDC fallback）。",
    contractLabel: "AgentPay 合约",
    contractTodo: "合约尚未部署 —— 当前回落到 mock 路径。",
    contractDone: "合约地址已加载。",
    contractHintAdmin: "管理员：运行 ./scripts/deploy.sh",
    actionConfigure: "去配置",
    actionConnect: "连接钱包",
    actionSwitch: "切换链",
    actionSwitching: "切换中…",
