...
const dict = {
  ...
  payment: {
    ...
    price: "Price",
    method: "Method",
    monFallbackHint: "Insufficient USDC, paying with native MON instead.",
    network: "Network",
    gasFee: "Gas fee",
  ...
  tx: {
    ...
    apiKeyHint: "Store this securely — the provider accepts it as a bearer token.",
    ...
    issueFailedTitle: "Payment confirmed, key issuance failed",
    issueFailedDesc:
      "Your USDC payment landed on-chain but the server couldn't verify the event. You can safely retry.",
    issueFailedRetry: "Retry key issuance",
    issueFailedSupport: "View tx on explorer",
  },
  ...
  setup: {
    ...
    title: "{n} of {total} ready — finish setup to run the live demo",
    llmLabel: "LLM API key",
    llmTodo: "Configure at least one model to power the agent.",
    llmDone: "Model key configured.",
    walletLabel: "Wallet",
    walletTodo: "Connect a wallet to sign Monad transactions.",
    walletDone: "Wallet connected.",
    chainLabel: "Monad Testnet",
    chainTodo: "Switch your wallet to Monad Testnet (chain id 10143).",
    chainDone: "On Monad Testnet.",
    balanceLabel: "Test funds",
    balanceNoMon: "Need a small amount of MON for gas.",
    balanceNoUsdc: "Need test USDC to complete a purchase (≥ 3.8 USDC).",
    balanceNoFunds: "Need either ≥ 3.8 USDC, or ≥ 0.039 MON (USDC fallback).",
    balancePendingChain: "Connect & switch chain first.",
    balanceDone: "Wallet funded for the demo.",
    balanceDoneMon: "Funded — will pay in native MON (USDC fallback).",
    contractLabel: "AgentPay contract",
    contractTodo: "Contract not deployed — payments will fall back to mock.",
    contractDone: "Contract address loaded.",
    contractHintAdmin: "Admin: run ./scripts/deploy.sh",
    actionConfigure: "Configure",
    actionConnect: "Connect",
    actionSwitch: "Switch",
    actionSwitching: "Switching…",
    actionFaucet: "Faucet",
  },
